...
RUN apt-get -y update &&  apt -y upgrade \
	...
	&& apt-get update \
	&& apt-get -y install r-base-core=4.2.1-2~bullseyecran.0 --allow-downgrades linux-libc-dev- gcc-10- \
	&& apt-get -y install r-doc-html=4.2.1-2~bullseyecran.0 --allow-downgrades \
	&& R CMD javareconf \

#docker build . -t quay.io/semoss/docker-r:cuda-builder
...
RUN apt-get update \
	...
	&& apt-get -y install r-doc-html=4.2.1-1.2004.0 --allow-downgrades \
	&& apt-get -y install r-base-dev=4.2.1-1.2004.0 --allow-downgrades \
	&& R CMD javareconf \

...
if [[ $arch == x86_64* ]]; then
	...
	apt-get -y install r-base-core=4.2.3-1~bullseyecran.0 --allow-downgrades linux-libc-dev- gcc-10-
	apt-get -y install r-doc-html=4.2.3-1~bullseyecran.0 --allow-downgrades

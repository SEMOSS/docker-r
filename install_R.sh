...
if [[ $arch == x86_64* ]]; then
    ...
    apt-get -y install r-base-core=4.3.3-2~bullseyecran.0 --allow-downgrades linux-libc-dev- gcc-10-
    apt-get -y install r-doc-html=4.3.3-2~bullseyecran.0 --allow-downgrades
    apt-get -y install r-base-dev=4.3.3-2~bullseyecran.0 --allow-downgrades
